...
class CVAE(nn.Module):
    def __init__(self, in_channel, data_shape, data_size, hid_size, enc_size, label_len, bias=True):
    ...
    def forward(self, x, label):
        ...
        mu, logvar = self.encode(x, onehot)
        z = self.reparameterize(mu, logvar)
        return self.decode(z, onehot), mu, logvar
